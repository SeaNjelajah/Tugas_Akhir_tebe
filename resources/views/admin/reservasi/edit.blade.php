...
<form method="POST" role="form" action="{{ route('admin.reservasi.update', $reservasi->id) }}" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    <div class="wowload fadeInRight">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nama_tamu" value="{{ $reservasi->nama_tamu }}" required name="nama_tamu" type="text" class="form-control" placeholder="Nama*">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" required value="{{ $reservasi->email }}" name="email" type="email" class="form-control" placeholder="Email*">
                        ...
                        <div class="form-group">
                            ...
                            <input id="no_tlp" required value="{{ $reservasi->no_tlp  }}" name="no_tlp" type="Phone" class="form-control" placeholder="No. Telepon*">
                        ...
                        <div class="form-group">
                            ...
                            <input id="jumlah_k" required value="{{ $reservasi->jumlah_k }}" name="jumlah_k" min="1" type="number" class="form-control" placeholder="Jumlah Kamar*">
                        ...
                        <div class="form-group">
                            ...
                            <input id="jumlah_d" required value="{{ $reservasi->jumlah_d }}" name="jumlah_d" min="1" type="number" class="form-control" placeholder="Jumlah Dewasa*">

                        </div>

                        <div class="form-group">
                            <label for="jumlah_a">Jumlah Anak <sup>2</sup> </label>
                            <input id="jumlah_a" required name="jumlah_a" value="{{ $reservasi->jumlah_a }}" min="0" type="number" class="form-control" placeholder="Jumlah Anak*">
                        </div>

                        <div class="form-group">
                            <label for="pesan_lain">Pesan Lain</label>
                            <textarea id="pesan_lain" required name="pesan_lain" class="form-control" placeholder="Pesan Lain" rows="4">{{ $reservasi->pesan_lain }}</textarea>
                        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-prepend">
                            ...
                            <input value="{{ Carbon\Carbon::create($reservasi->check_in)->toDateTimeLocalString() }}" id="check_in_input" type="datetime-local" name="check_in" class="form-control">
                    ...
                    <div class="form-group">
                        <div class="input-group-prepend">
                            ...
                            <input required value="{{ Carbon\Carbon::create($reservasi->check_out)->toDateTimeLocalString() }}" type="datetime-local" name="check_out" class="form-control">
                        </div>
    ...
    <div class="card card-primary mt-2" id="card_pilih_kamar">
        ...
        <div class="card-header">
            <div class="row p-0 m-0">
                ...
                <div class="col-auto ml-auto p-0 m-0 mr-2">
                    <h4 id="kamar_terpilih" class="m-0 card-title">{{ $reservasi->kamar()->count() }} Kamar Terpilih</h4>
                </div>
                        ...
                        <td colspan="5">
                            ...
                            <div class="card m-0">
                                ...
                                <div class="card-footer d-inline-flex justify-content-end">
                                    ...
                                    <input value="{{ $kamar->pivot->jumlah_kamar }}"  set="jumlah_kamar_terpilih"  class="w-25 form-control mr-1" type="number" min="0" id="id_jumlah_kamar_terpilih">
        ...
        @if ($reservasi->kamar()->first())
            @foreach ($reservasi->kamar as $kamar)
            <input set="terpilih" type="hidden" name="kamar_terpilih[{{ $kamar->id }}]" value="{{ $kamar->pivot->jumlah_kamar }}">
            @endforeach
        @endif
